...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], UsersResolver.prototype, "findUserByEmail", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get a user by email and password' }),
    (0, graphql_1.Query)(() => user_entity_1.User, { name: 'userByEmailAndPassword' }),
    __param(0, (0, graphql_1.Args)('email')),
